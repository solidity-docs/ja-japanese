...
コンパイラは、ライブラリが配置されるアドレスを知らないため、コンパイルされた16進コードには ``__$30bbc0abd4d6364515865950d3e0d10953$__`` という形式のプレースホルダーが含まれます `(このフォーマットは <v0.5.0 では異なっていました) <https://docs.soliditylang.org/en/v0.4.26/contracts.html#libraries>`_ 。
